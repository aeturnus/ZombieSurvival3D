...
#define Timer0_Disable() (TIMER0_CTL_R = 0x00000000)
#define Timer0_Enable() (TIMER0_CTL_R = 0x00000001)
#define Timer0_DisableInt() (NVIC_EN0_R = NVIC_EN0_R&(~(1<<19)))
#define Timer0_EnableInt() (NVIC_EN0_R |= (1<<19))
